...
MySQL - 8.0.18 : Database - blackshop_user
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`blackshop_user` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `sys_menu`(`menu_id`,`name`,`permission`,`url`,`parent_id`,`icon`,`create_time`,`update_time`,`sort`) values
...
insert  into `sys_role`(`role_id`,`role_name`,`role_code`,`role_desc`,`ds_type`,`ds_scope`,`create_time`,`update_time`,`del_flag`) values
...
insert  into `sys_user`(`user_id`,`username`,`password`,`avatar`,`email`,`phone_number`,`status`,`create_time`,`update_time`) values
