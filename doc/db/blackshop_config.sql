...
(17,'black-shop-gateway-dev.yml','DEFAULT_GROUP','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: auth-service\r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n            - Path=/auth2/**\r\n          filters:\r\n            - StripPrefix=1\r\n        - id: user-service\r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/test/**\r\n          filters:\r\n            - StripPrefix=1','5c4616181083e724284b7ef96c31579a','2020-03-26 22:04:36','2020-03-26 23:49:49',NULL,'0:0:0:0:0:0:0:1','','','网关配置','null','null','yaml','null');
...
(0,14,'application.yml','DEFAULT_GROUP','','user:\r\n  name: zyizou\r\n  age: 26','4d895b64039936b00aa816b3cbe3ded1','2010-05-05 00:00:00','2020-03-23 23:45:07',NULL,'0:0:0:0:0:0:0:1','I','bd19918b-7773-48eb-9cee-106f7bf94789'),
(0,15,'nacos-config-example.properties','DEFAULT_GROUP','','user.name=zyizou\r\nuser.age=26','dc2278ebd3017ddb52b0e7158d7d2b04','2010-05-05 00:00:00','2020-03-23 23:51:14',NULL,'0:0:0:0:0:0:0:1','I',''),
(15,16,'nacos-config-example.properties','DEFAULT_GROUP','','user.name=zyizou\r\nuser.age=26','dc2278ebd3017ddb52b0e7158d7d2b04','2010-05-05 00:00:00','2020-03-24 00:12:08',NULL,'0:0:0:0:0:0:0:1','U',''),
(0,17,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates: # 断言，路径相匹配的进行路由\r\n            - Path=/auth/**','2580507033386f438da9af897b2840ab','2010-05-05 00:00:00','2020-03-26 22:04:36',NULL,'0:0:0:0:0:0:0:1','I',''),
(17,18,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates: # 断言，路径相匹配的进行路由\r\n            - Path=/auth/**','2580507033386f438da9af897b2840ab','2010-05-05 00:00:00','2020-03-26 22:06:02',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,19,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates: # 断言，路径相匹配的进行路由\r\n            - Path=/auth/**\r\n      routes:\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates: # 断言，路径相匹配的进行路由\r\n            - Path=/user/**','dcfacd61e29c61db0912458d9527f00b','2010-05-05 00:00:00','2020-03-26 22:30:32',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,20,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n           - Path=/auth/**\r\n      routes:\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/user/**','30a3fb9b3d82758bd88758e860263265','2010-05-05 00:00:00','2020-03-26 22:31:12',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,21,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n           - Path=/auth/**\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/user/**','65a54e6029fba2699c7363be144e8027','2010-05-05 00:00:00','2020-03-26 23:00:48',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,22,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n           - Path=/auth/**\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/user/**','65a54e6029fba2699c7363be144e8027','2010-05-05 00:00:00','2020-03-26 23:24:59',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,23,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n           - Path=/auth/**\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/user/**','65a54e6029fba2699c7363be144e8027','2010-05-05 00:00:00','2020-03-26 23:32:21',NULL,'0:0:0:0:0:0:0:1','U',''),
(17,24,'black-shop-gateway-dev.yml','DEFAULT_GROUP','','spring:\r\n  cloud:\r\n    gateway:\r\n      routes:\r\n        - id: black-shop-auth \r\n          uri: lb://black-shop-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n        - id: black-shop-user-service \r\n          uri: lb://black-shop-user-service\r\n          predicates:\r\n            - Path=/user/**','75f547020dfce4c6f7424010debe7789','2010-05-05 00:00:00','2020-03-26 23:49:49',NULL,'0:0:0:0:0:0:0:1','U','');
