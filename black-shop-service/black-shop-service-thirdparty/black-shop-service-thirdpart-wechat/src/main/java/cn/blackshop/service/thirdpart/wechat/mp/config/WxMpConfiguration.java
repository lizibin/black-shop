package cn.blackshop.service.thirdpart.wechat.mp.config;
...
import cn.blackshop.service.thirdpart.wechat.mp.handler.KfSessionHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.LocationHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.LogHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.MenuHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.MsgHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.NullHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.ScanHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.StoreCheckNotifyHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.SubscribeHandler;
import cn.blackshop.service.thirdpart.wechat.mp.handler.UnsubscribeHandler;
...
public class WxMpConfiguration {
  ...
  private WxMpMessageRouter newRouter(WxMpService wxMpService) {
    ...
    // 关注事件
    newRouter.rule().async(false).msgType(XmlMsgType.EVENT).event(EventType.SUBSCRIBE).handler(this.subscribeHandler)
        .end();
